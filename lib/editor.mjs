...
const EDIT_DESCRIPTION =
  ...
  + 'failing. A literal matching more than once is refused unless `count` declares how many you expect. '
  + 'Whitespace is ignored while matching (spaces, blank lines, line breaks); a character difference is '
  + 'refused, naming the first line that differs.'
